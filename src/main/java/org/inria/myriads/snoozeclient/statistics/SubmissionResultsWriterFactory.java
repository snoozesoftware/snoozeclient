...
public final class SubmissionResultsWriterFactory 
{
     ...
     * @return                          The submission results writer
     * @throws IOException              The I/O exception
     */
    public static SubmissionResultsWriter newSubmissionResultsWriter(String fileName, 
                                                                     StatisticsFormat statisticsOutputFormat)
        throws IOException
    {
        return new SubmissionResultsWriter(fileName, statisticsOutputFormat);
    }
}
